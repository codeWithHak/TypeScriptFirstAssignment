...
var fav_fruits = ["grapes", "pomegranate", "orange"];
if (fav_fruits.indexOf("grapes") !== -1) {
    console.log("Yoy really like ".concat(fav_fruits[0]));
}
if (fav_fruits.indexOf("bananas") !== -1) {
    console.log("Yoy really like ".concat(fav_fruits[1]));
}
...
if (fav_fruits.indexOf("orange") !== -1) {
    console.log("Yoy really like ".concat(fav_fruits[2]));
}
